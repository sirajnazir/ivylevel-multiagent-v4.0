...
export const sessionMetadataSchema = z.object({
  ...
  alternate_archetype_labels: z.array(z.string()),
  grade_level: z.number(),
  session_duration_minutes: z.number(),
  coach_id: z.string(),
  supporting_coaches: z.array(z.string()),
  session_date: z.string(),
  student_readiness_score: z.number(),
  academic_score: z.number(),
  ec_score: z.number(),
  character_score: z.number(),
  fit_score: z.number(),
  signature_project_identified: z.boolean(),
  signature_project: z.string().optional(),
  timeline_urgency: z.string(),
  months_until_applications: z.number(),
  ...
  school_context: z.string(),
  cultural_background: z.string(),
  family_support_level: z.string(),
...
export const jennyAssessmentStructuredSchema_v1 = z.object({
  ...
  key_challenges: keyChallengesSchema,
  gameplan_structure_analysis: z.record(z.string(), z.any()).optional(),
  frameworks_introduced: z.array(frameworkSchema),
  strategic_recommendations: strategicRecommendationsSchema,
  timeline_and_milestones: timelineAndMilestonesSchema,
  narrative_development: narrativeDevelopmentSchema,
  coaching_tactics_observed: coachingTacticsObservedSchema,
  comparison_with_zainab: z.record(z.string(), z.any()).optional(),
  archetype_specific_patterns: z.record(z.string(), z.any()).optional(),
  knowledge_moat_insights: z.array(knowledgeMoatInsightSchema),
